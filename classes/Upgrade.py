...
class Upgrade(AoeElement):
    ...
    #### Barracks
    # Militia-line
    def research_man_at_arms_upgrade(self):
        self.name = "Man-at-Arms Upgrade"
        self.cost = {"Food": 100, "Gold": 40}
        self.research_time = 0
        self.target = [Unit]

    def research_supplies(self):
        self.name = "Supplies"
        self.cost = {"Food": 100, "Gold": 40}
        self.explanation_text = "Militia-line costs -15 food."
        self.research_time = 35
        self.target = [Unit]

    def research_squires(self):
        self.name = "Squires"
        self.cost = {"Food": 100}
        self.explanation_text = "Infantry move 10% faster."
        self.research_time = 40
        self.target = [Unit]

    def research_arson(self):
        self.name = "Arson"
        self.cost = {"Food": 150, "Gold": 50}
        self.explanation_text = "Infantry do more damage vs. buildings."
    ...
    #### Dock
    def research_gillnets(self):
        self.name = "Gillnets"
        self.cost = {"Food": 150, "Wood": 200}
        self.explanation_text = "Fishing Ships gather 25% faster."
        self.research_time = 45
        self.target = [Unit]

    def research_careening(self):
        self.name = "Careening"
        self.cost = {"Food": 250, "Gold": 150}
        self.explanation_text = "Makes ships less vulnerable to missile attack with +1 pierce armor. Transport Ships carry +5 units."
        self.research_time = 50
        self.target = [Unit]

    def research_dry_dock(self):
        self.name = "Dry Dock"
        self.cost = {"Food": 600, "Gold": 400}
        self.explanation_text = "Ships move 15% faster. Transport Ships carry +10 units."
        self.research_time = 60
        self.target = [Unit]

    def research_shipwright(self):
        self.name = "Shipwright"
        self.cost = {"Food": 1000, "Gold": 300}
        self.explanation_text = "Ships cost 20% less wood; build 35% faster."
        self.research_time = 60
        self.target = [Unit]
    ...
    #### Lumber Camp
    def research_double_bit_axe(self):
        self.name = "Double-Bit Axe"
        self.cost = {"Food": 100, "Wood": 50}
        self.explanation_text = "Villagers chop wood 20% faster."
        self.research_time = 25
        self.target = [Unit]

    def research_bow_saw(self):
        self.name = "Bow Saw"
        self.cost = {"Food": 150, "Wood": 100}
        self.explanation_text = "Villagers chop wood 20% faster."
        self.research_time = 50
        self.target = [Unit]

    def research_two_man_saw(self):
        self.name = "Two-Man Saw"
        self.cost = {"Food": 300, "Wood": 200}
        self.explanation_text = "Villagers chop wood 10% faster."
        self.research_time = 100
        self.target = [Unit]

    #### Mill
    def research_horse_collar(self):
        self.name = "Horse Collar"
        self.cost = {"Food": 75, "Wood": 75}
        self.explanation_text = "Farms produce +75 food so they last longer before you must rebuild them."
        self.research_time = 20
        self.target = [Unit]

    def research_heavy_plow(self):
        self.name = "Heavy Plow"
        self.cost = {"Food": 125, "Wood": 125}
        self.explanation_text = "Farms produce +125 food so they last longer before you must rebuild them. Farmers carry +1 food each trip."
        self.research_time = 40
        self.target = [Unit]

    def research_crop_rotation(self):
        self.name = "Crop Rotation"
        self.cost = {"Food": 250, "Wood": 250}
        self.explanation_text = "Farms produce +175 food so they last longer before you must rebuild them."
        self.research_time = 70
        self.target = [Unit]

    #### Mining Camp
    def research_gold_mining(self):
        self.name = "Gold Mining"
        self.cost = {"Food": 100, "Wood": 75}
        self.explanation_text = "Villagers mine gold 15% faster."
        self.research_time = 30
        self.target = [Unit]

    def research_gold_shaft_mining(self):
        self.name = "Gold Shaft Mining"
        self.cost = {"Food": 200, "Wood": 150}
        self.explanation_text = "Villagers mine gold 15% faster."
        self.research_time = 75
        self.target = [Unit]

    def research_stone_mining(self):
        self.name = "Stone Mining"
        self.cost = {"Food": 100, "Wood": 75}
        self.explanation_text = "Villagers mine stone 15% faster."
        self.research_time = 30
        self.target = [Unit]

    def research_stone_shaft_mining(self):
        self.name = "Stone Shaft Mining"
        self.cost = {"Food": 200, "Wood": 150}
        self.explanation_text = "Villagers mine stone 15% faster."
        self.research_time = 75
        self.target = [Unit]
